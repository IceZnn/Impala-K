<x-app-layout>
    ...
    <body style="
        background: linear-gradient(rgba(255, 248, 240, 0.8), rgba(230, 220, 210, 0.8)), url('/slakarai1.jpg');
            ...
            <div class="col-lg-8 col-md-10 col-sm-12">
                <div class="card shadow-lg border-0 rounded-3" style="background: rgba(255, 255, 255, 0.95); backdrop-filter: blur(10px);">
                    <div class="card-header bg-gradient-dark text-white text-center py-4 border-0">
                        <h4 class="mb-0 fw-bold"><i class="fas fa-eye me-2"></i>Visualizar Produto</h4>
                        <p class="mb-0 mt-2 opacity-75">Detalhes completos do produto</p>
                    </div>
                        ...
                        <form>
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <input type="text" name="Ano" id="Ano" disabled value="{{$produto->Ano}}"  
                                        class="form-control form-control-lg border-start-0 bg-light" 
                            ...
                            <div class="mb-4">
                                ...
                                <div class="input-group">
                                    ...
                                    <textarea name="estado" id="estado" disabled class="form-control form-control-lg border-start-0 bg-light" 
                                        rows="4" placeholder="Descrição do produto">{{$produto->estado}}</textarea>
                                </div>
                            </div>

                            <!-- Botões de Ação -->
                            <div class="d-flex gap-3 mt-4">
                                <a href="{{ route('dashboard') }}" class="btn btn-outline-secondary btn-lg rounded-pill py-3 fw-semibold flex-fill">
                                    <i class="fas fa-arrow-left me-2"></i>Voltar ao Dashboard
                                </a>
                                <a href="{{ route('dashboard') }}" class="btn btn-primary btn-lg shadow-sm rounded-pill py-3 fw-bold flex-fill">
                                    <i class="fas fa-check me-2"></i>Confirmar Visualização
                                </a>
                            </div>
                        </form>
                    </div>
